            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="/images/BCG.png" style="max-width: 100%" alt="">
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="mt-3">Vaccine: Bacillus Calmette–Guérin (BCG)</div>
                                        <div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            data-target="#bcg" id="#modalScroll" class="btn text-white" style="background-color: #C8A796">More Details</button>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="/images/HepatitisB.png" style="max-width: 100%; max-height:100%" alt="">
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="mt-3">Vaccine: Hepatitis B</div>
                                        <div>
                                        ...
                                        <div class="mt-3">
                                            <button data-toggle="modal"
                                            data-target="#hepb" id="#modalScroll" class="btn text-white" style="background-color: #C8A796">More Details</button>
                                        </div>
                                    </div>
                                    <div class="col-md-5 mt-3 d-flex justify-content-center">
                                        <img src="/images/2.png" class="mx-auto" style="max-width: 50%;" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="/images/pentavalent-vaccine.png" style="max-width: 100%; max-height:100%" alt="">
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="mt-3">Vaccine: Pentavalent Vaccine</div>
                                        <div>
                                            Protection from: Diphtheria, Pertussis, Tetanus, Haemophilus Influenzae type
                                            b and Hepatitis B
                                        </div>
                                        <div>
                                            When to give: 6, 10 and 14 weeks from Birth
                                        </div>
                                        <div class="mt-3">
                                            <button data-toggle="modal"
                                            data-target="#penta" id="#modalScroll" class="btn text-white" style="background-color: #C8A796">More Details</button>
                                        </div>
                                    </div>
                                    <div class="col-md-5 mt-3 d-flex justify-content-center">
                                        <img src="/images/2.png" class="mx-auto" style="max-width: 50%;" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="/images/opv.png" style="max-width: 100%; max-height:100%" alt="">
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="mt-3">Vaccine: Oral Polio Vaccine (OPV)</div>
                                        <div>
                                        ...
                                        <div class="mt-3">
                                            <button data-toggle="modal"
                                            data-target="#opv" id="#modalScroll" class="btn text-white" style="background-color: #C8A796">More Details</button>
                                        </div>
                                    </div>
                                    <div class="col-md-5 mt-3 d-flex justify-content-center">
                                        <img src="/images/2.png" class="mx-auto" style="max-width: 50%;" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="/images/ipv.png" style="max-width: 100%; max-height:100%" alt="">
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="mt-3">Vaccine: Inactivated Polio Vaccine (IPV)</div>
                                        <div>
                                            Protection from: Poliovirus
                                        </div>
                                        <div>
                                            When to give: 14 weeks from Birth
                                        </div>
                                        <div class="mt-3">
                                            <button data-toggle="modal"
                                            data-target="#ipv" id="#modalScroll" class="btn text-white" style="background-color: #C8A796">More Details</button>
                                        </div>
                                    </div>
                                    <div class="col-md-5 mt-3 d-flex justify-content-center">
                                        <img src="/images/2.png" class="mx-auto" style="max-width: 50%;" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="/images/pcv-v2.png" style="max-width: 100%; max-height:100%" alt="">
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="mt-3">Pneumococcal Conjugate Vaccine (PCV)</div>
                                        <div>
                                        ...
                                        <div class="mt-3">
                                            <button data-toggle="modal"
                                            data-target="#pcv" id="#modalScroll" class="btn text-white" style="background-color: #C8A796">More Details</button>
                                        </div>
                                    </div>
                                    <div class="col-md-5 mt-3 d-flex justify-content-center">
                                        <img src="/images/2.png" class="mx-auto" style="max-width: 50%;" alt="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="row">
                            <div class="col-md-3">
                                <img src="/images/mmr.png" style="max-width: 100%; max-height:100%" alt="">
                            </div>
                            <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="mt-3">Measles, Mumps, Rubella (MMR)</div>
                                        <div>
                                            Protection from: Measles, Mumps and Rubella
                                        </div>
                                        <div>
                                            When to give: 9 months and 1 year old from Birth
                                        </div>
                                        <div class="mt-3">
                                            <button data-toggle="modal"
                                            data-target="#mmr" id="#modalScroll" class="btn text-white" style="background-color: #C8A796">More Details</button>
                                        </div>
                                    </div>
                                    <div class="col-md-5 mt-3 d-flex justify-content-center">
                                        <img src="/images/2.png" class="mx-auto" style="max-width: 50%;" alt="">
